...
function GeneralSection() {
  ...
  const [notifSav, setNotifSav] = useState(true)
  const [notifTokens, setNotifTokens] = useState(false)
    ...
    <div className="space-y-10">
      ...
      <div className="border-t border-gray-100 pt-8">
        ...
        <div className="divide-y divide-gray-50">
          {[
            { label: 'Nouveau document à signer', value: notifDocs, set: setNotifDocs },
            { label: 'Réponse à un ticket SAV', value: notifSav, set: setNotifSav },
            { label: 'Solde de tokens faible', value: notifTokens, set: setNotifTokens },
          ].map(({ label, value, set }) => (
  ...
  return (
    <div className="space-y-10">
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mb-4">Minimum 6 caractères.</p>
