  ...
  return (
    <div className="min-h-screen flex" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="flex flex-col items-center justify-center px-8 py-12" style={{ flex: '0 0 44%' }}>
        <div className="w-full max-w-[360px]">
          <Link to="/" className="inline-flex items-center gap-2 hover:opacity-70 transition-opacity mb-14">
            <img src="/logo-wake.png" alt="Wake Systems" className="h-6 w-auto" />
            <span style={{ fontSize: 15, fontWeight: 400, color: '#1A1A1A', fontFamily: "'Instrument Serif', Georgia, serif" }}>Wake Systems</span>
          </Link>
      ...
      <div className="hidden md:flex relative overflow-hidden" style={{ flex: 1, background: '#f0ede8' }}>
        <img src="/login-bg-2.jpg" alt="" className="absolute inset-0 w-full h-full object-cover opacity-90" style={{ objectPosition: 'left center' }} />
        <div
